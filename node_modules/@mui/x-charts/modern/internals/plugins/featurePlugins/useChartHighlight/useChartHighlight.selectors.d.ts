...
export declare const selectorChartsHighlightScope: ((state: import("../../corePlugins/useChartId/useChartId.types").UseChartIdState & import("../../corePlugins/useChartDimensions/useChartDimensions.types").UseChartDimensionsState & import("../../corePlugins/useChartSeries/useChartSeries.types").UseChartSeriesState<keyof import("../../..").ChartsSeriesConfig> & Partial<{}> & {
  cacheKey: import("../../models").ChartStateCacheKey;
...
export declare const selectorChartsIsHighlightedCallback: ((state: import("../../corePlugins/useChartId/useChartId.types").UseChartIdState & import("../../corePlugins/useChartDimensions/useChartDimensions.types").UseChartDimensionsState & import("../../corePlugins/useChartSeries/useChartSeries.types").UseChartSeriesState<keyof import("../../..").ChartsSeriesConfig> & Partial<{}> & {
  cacheKey: import("../../models").ChartStateCacheKey;
...
export declare const selectorChartsIsFadedCallback: ((state: import("../../corePlugins/useChartId/useChartId.types").UseChartIdState & import("../../corePlugins/useChartDimensions/useChartDimensions.types").UseChartDimensionsState & import("../../corePlugins/useChartSeries/useChartSeries.types").UseChartSeriesState<keyof import("../../..").ChartsSeriesConfig> & Partial<{}> & {
  cacheKey: import("../../models").ChartStateCacheKey;
} & import("./useChartHighlight.types").UseChartHighlightState) => (item: HighlightItemData | null) => boolean) & {
  clearCache: () => void;
  resultsCount: () => number;
